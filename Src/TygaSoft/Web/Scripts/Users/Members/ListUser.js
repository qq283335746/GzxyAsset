...
var ListUser = {
        ...
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要执行此操作吗？', function (r) {
                if (r) {
                    ...
                    $.ajax({
                        url: "/asset/Services/SecurityService.svc/SaveIsLockedOut",
                        type: "post",
                        data: '{"model":' + sData + '}',
        ...
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要执行此操作吗？', function (r) {
                if (r) {
                    var sData = '{"userName":"' + currObj.attr("code") + '"}';
                    $.ajax({
                        url: "/asset/Services/SecurityService.svc/SaveIsApproved",
                        type: "post",
                        data: sData,
                        contentType: "application/json; charset=utf-8",
                        beforeSend: function () {
        ...
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    ...
                    $.ajax({
                        url: "/asset/Services/SecurityService.svc/DelUser",
                        type: "post",
                        contentType: "application/json; charset=utf-8",
                        data: sData,
                        beforeSend: function () {
    ...
    CbIsInRole: function (h) {
        try {
            ...
            $.ajax({
                url: "/asset/Services/SecurityService.svc/SaveUserInRole",
                type: "post",
                contentType: "application/json; charset=utf-8",
                data: sData,
                beforeSend: function () {
    ...
    OnRoleLoadSuccess: function (data) {
        try {
            ...
            if (rows && rows.length > 0) {
                $.ajax({
                    url: "/asset/Services/SecurityService.svc/GetUserInRole",
                    type: "post",
                    contentType: "application/json; charset=utf-8",
    ...
    ResetPassword: function () {
        ...
        $.messager.confirm('温馨提醒', '确定要重置该用户的密码吗？', function (r) {
            if (r) {
                ...
                $.ajax({
                    url: "/asset/Services/SecurityService.svc/ResetPassword",
                    type: "post",
                    contentType: "application/json; charset=utf-8",
                    data: '{"username":"' + username + '"}',
                    beforeSend: function () {
    ...
    UserDataPermission: function () {
        ...
        $("#dlgUserDataPermission").dialog({
            ...
            height: 300,
            closed: false,
            href: '../u/tsys.html?userName=' + userName + '',
            modal: true,
            iconCls: 'icon-add',
            buttons: [{
