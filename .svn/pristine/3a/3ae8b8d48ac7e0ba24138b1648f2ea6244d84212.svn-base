...
<head runat="server">
    ...
    <script src="Scripts/plugins/Jeasyui145/jquery.min.js" type="text/javascript"></script>
    <script src="Scripts/Plugins/Jeasyui145/jquery.easyui.min.js" type="text/javascript"></script>
    <script src="Scripts/Plugins/Jeasyui145/locale/easyui-lang-zh_CN.js" type="text/javascript"></script>
