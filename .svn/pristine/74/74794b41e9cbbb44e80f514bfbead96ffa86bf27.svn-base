<%@ Page Title="用户角色分配" Language="C#" MasterPageFile="~/Users/Users.Master" AutoEventWireup="true" CodeBehind="AddUserRole.aspx.cs" Inherits="TygaSoft.Web.Users.Members.AddUserRole" %>
