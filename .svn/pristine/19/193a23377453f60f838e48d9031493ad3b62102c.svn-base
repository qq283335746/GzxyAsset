<%@ Page Title="成员管理" Language="C#" MasterPageFile="~/Users/Users.Master" AutoEventWireup="true" CodeBehind="ListUsers.aspx.cs" Inherits="TygaSoft.Web.Users.Members.ListUsers" %>
...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div data-options="region:'center',title:''">
        <div id="toolbar" style="padding:5px;">
            ...
            <a name="abtnUserDataPermission" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" runat="server" id="abtnUserDataPermission">数据权限</a>
            <a class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="ListUser.UserAccess()">用户授权</a>
        </div>

        <table id="bindT" class="easyui-datagrid" title="用户列表" data-options="rownumbers:true,pagination:true,fit:true,fitColumns:true,singleSelect:true,border:false,toolbar:'#toolbar'">
        <thead>
            <tr>
...
<script type="text/javascript" src="/asset/Scripts/Users/Members/ListUser.js"></script>
