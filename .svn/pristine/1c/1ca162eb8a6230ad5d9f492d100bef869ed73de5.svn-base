...
namespace TygaSoft.Web.Users
{
    public partial class DlgUpload : System.Web.UI.Page
    {
        ...
        private void Bind()
        {
            ...
            {
                myDataAppend.Replace("{CallBack}", string.Format("$(\"#{0}\").dialog('refresh','{1}');", dlgParentId, "/asset/u/pictureselect.html?dlgId=" + dlgParentId + "&funName=" + funName + "&isMutil=" + isMutilSelect + ""));
            }
            else
            {
