var ListRoleMenu = {
    ...
    OnSave: function () {
        ...
        var sUrl = Common.AppName + "/Services/SecurityService.svc/SaveRoleMenu";
        var sData = '{"model":{"RoleName":"' + sRoleName + '","UserName":"' + sUserName + '","MenuItemJson":"' + encodeURIComponent(sJson) + '"}';
        ...
        $.ajax({
            ...
            success: function (result) {
                //console.log('SaveRoleMenu--' + JSON.stringify(result));
                if (result.ResCode != 1000) {
                    $.messager.alert('系统提示', result.Msg, 'info');
                    return;
                }
