<%@ Page Title="角色管理" Language="C#" MasterPageFile="~/Users/Users.Master" AutoEventWireup="true" CodeBehind="ListRoles.aspx.cs" Inherits="TygaSoft.Web.Users.Members.ListRoles" %>
...
<div id="toolbar" style="padding:5px;">
    ...
    <a class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="currFun.Edit()">编辑</a>
    <a class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true" onclick="currFun.Del()">删除</a>
    <a class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="currFun.RoleMenu()">角色授权</a>
</div>

<table id="bindT" class="easyui-datagrid" title="角色列表" data-options="rownumbers:true,fit:true,singleSelect:true,fitColumns:true,toolbar:'#toolbar'">
<thead>
    <tr>
...
<script type="text/javascript">
    var currFun = {
        Add: function () {
            $("#hId").val("");
            $("#txtRolename").val("");
            currFun.Url = "/asset/Services/SecurityService.svc/SaveRole";
        ...
        Del: function () {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    ...
                    $.ajax({
                        url: "/asset/Services/SecurityService.svc/DelRole",
                        type: "post",
