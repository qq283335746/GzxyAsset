<%@ Page Title="新建/编辑用户" Language="C#" MasterPageFile="~/Users/Users.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="TygaSoft.Web.Users.Members.AddUser" %>
 ...
 <script type="text/javascript">
     $(function () {
         ...
         $("#txtUserName").blur(function () {
             $.ajax({
                 url: "/asset/Services/SecurityService.svc/CheckUserName",
                 type: "post",
     ...
     var currFun = {
         ...
         Save: function () {
             ...
             try {
                 ...
                 $.ajax({
                     url: "/asset/Services/SecurityService.svc/SaveUser",
                     type: "post",
                     contentType: "application/json; charset=utf-8",
                     data: '{"model":' + sData + '}',
                     beforeSend: function () {
