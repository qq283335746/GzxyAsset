...
namespace TygaSoft.SqlServerDAL
{
    public partial class Category : ICategory
    {
        ...
        public int Insert(CategoryInfo model)
        {
            ...
            sb.Append(@"insert into Category (ParentId,Coded,Named,Remark,Sort,LastUpdatedDate,UserId)
			            values
...
new SqlParameter("@UserId",SqlDbType.UniqueIdentifier)
        ...
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update Category set ParentId = @ParentId,Coded = @Coded,Named = @Named,Remark = @Remark,Sort = @Sort,LastUpdatedDate = @LastUpdatedDate,UserId = @UserId 
			            where Id = @Id
					    ");
