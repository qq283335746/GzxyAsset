...
namespace TygaSoft.SqlServerDAL
{
    public partial class Menus : IMenus
    {
        ...
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append(@"update Menus set ApplicationId = @ApplicationId,ParentId = @ParentId,IdStep = @IdStep,Title = @Title,Url = @Url,Descr = @Descr,AllowRoles = @AllowRoles,DenyUsers = @DenyUsers,Sort = @Sort,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
        ...
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from Menus where Id = @Id ");
            SqlParameter[] parms = {
                                     new SqlParameter("@Id",SqlDbType.UniqueIdentifier)
                                   };
            parms[0].Value = id;
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from Menus where Id = @Id" + n + " ;");
        ...
        public IList<MenusInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
            ...
            if (totalRecords == 0) return new List<MenusInfo>();
